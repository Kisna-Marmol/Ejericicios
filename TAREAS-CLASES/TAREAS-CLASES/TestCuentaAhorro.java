...
public class TestCuentaAhorro
{
    ...
    public static boolean depositar(){
        ...
        return false;//si no se cuentra el ID de cuenta
    }
    //Funcion para retirar en una cuenta
    public static boolean retirar(){
        String ID = FM.pedirCadena("Ingrese la cuenta a la que va retirar");
        double cantidad = FM.pedirDecimal("Ingrese la cantidad");
        ...
        return false;//si no se encuentra el ID de cuenta
    }
